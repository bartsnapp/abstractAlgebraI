...
\begin{definition}\index{homomorphism!of groups}\index{group homomorphism}
  ...
  \dfn{homomorphism} of groups if
  \[
  \phi(a\star b) = \phi(a)\diamond\phi(b).
  \]
\end{definition}

\begin{exercise}[Homomorphisms preserve identity]
...
\begin{lemma}[Homomorphisms preserve inverses]
...
\begin{exercise}[Canonical surjection]
  ...
  \dfn{canonical surjection} from $G$ to $G/N$.
\end{exercise}
