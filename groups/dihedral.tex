...
\begin{definition}
  Let $G$ be a group, the \dfn{order} of $g\in G$ is
  \[
  \o(g) := \min\{n>0: g^n = e\}.
  \]
\end{definition}
...
\begin{exercise}
  Find the order of each element of $T_{12}$. Organize this
...
\begin{exercise}
  ...
  \end{tikzpicture}
  \]
  Is this map in $T_{12}$? If so find the element. If not, explain why
  not.
\end{exercise}
...
\begin{exercise}
  List all elements of $T_{12}$ that leave vertex $4$ fixed. Show that these
  form a group.
\end{exercise}

\begin{exercise}
  List all elements of $T_{12}$ that leave vertex $3$ fixed. Show that these
  form a group.
\end{exercise}

\begin{exercise}\label{E:symcube}
  Let $C$ be the group of order preserving rigid motions of the
  cube. Compute $|C|$ and prove that your answer is correct.
\end{exercise}

\begin{exercise}\label{E:symoct}
  Let $O$ be the group of order preserving rigid motions of the
  octahedron. Compute $|O|$ and prove that your answer is correct.
\end{exercise}

\begin{exercise}
  What do you notice about your answers to Exercise~\ref{E:symcube}
  and Exercise~\ref{E:symoct}? Explain why this happens.
\end{exercise}


\begin{exercise}\label{E:symdoe}
  Let $D$ be the group of order preserving rigid motions of the
  doedecahedron. Compute $|D|$ and prove that your answer is correct.
\end{exercise}

\begin{exercise}\label{E:symicos}
  Let $I$ be the group of order preserving rigid motions of the
  icosahedron. Compute $|I|$ and prove that your answer is correct.
\end{exercise}

\begin{exercise}
  What do you notice about your answers to Exercise~\ref{E:symdoe}
  and Exercise~\ref{E:symicos}? Explain why this happens.
\end{exercise}
