...
\begin{exercise}
  ...
  \begin{hint}
    ...
    \[
    \{e, r, r^2,\dots,r^{n-1}, f, rf, r^2f \dots, r^{n-1}f\}
    \]
...
\begin{tikzpicture}
  ...
  \draw[fill] (3,1) circle (1mm) node[above right] {$A$};
  \draw[fill] (0,0) circle (1mm) node[left] {$B$};
  \draw[fill] (3,0) circle (1mm) node[right] {$C$};
  \draw[fill] (1.5,2.8) circle (1mm) node[above] {$D$};
\end{tikzpicture}
\]
