...
\begin{definition}
  ...
  \[
  a = \prodstar_{i=1}^m \prodstar_{k=1}^{\alpha_i}g_i
  \]
  ...
  \begin{align*}
  a &= \prod_{i=1}^m \prod_{k=1}^{\alpha_i}g_i\\
  &=  \prod_{i=1}^m g_i^{\alpha_i}.
  \end{align*}


  If the group has an operation like addition, we write
  \begin{align*}
  a &= \sum_{i=1}^m \sum_{k=1}^{\alpha_i}g_i\\
  &=  \sum_{i=1}^m \alpha_i \cdot g_i.
  \end{align*}
\end{definition}
