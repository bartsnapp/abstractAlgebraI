...
Here's a question for us to think about: Groups of permutations seem
really expressive.  Is every (finite) group isomorphic to a group of
permutations?


For some interesting extra reading check out:
\begin{itemize}
\item \link[\textit{Keeler's theorem and products of distinct transpositions}, R.~Evans, L.~Huang, and T.~Nguyen, arXiv.org, last revised 3 Oct 2012]{https://arxiv.org/abs/1204.6086}.
\item \link[\textit{For all possible distances look to the
    permutohedron}, J.~Santmyer, Mathematics Magazine, April 2007,
  120--125]{https://www.jstor.org/stable/27643009}.
\end{itemize}
