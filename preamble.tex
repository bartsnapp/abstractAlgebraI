...
\NewEnviron{annotate}{\small \itshape \BODY \vspace{.5cm}}
...
%%         \foreach \x in {0,1,...,\xx}
%%            {
%%            -- ({\rr*sin(\x*360/\xx + \pgfextra{\if\IsEven{\xx}180/\xx\else 0\fi} )},{\rr*cos(\x*360/\xx)}) 
%%            }
%%            -- cycle;
%%   }}}
  ...
  \foreach \x in {0,1,...,\xx-1}
           {
             ...
             at ({(\rr-\dd)*sin(\x*360/\xx)},{(\rr-\dd)*cos(\x*360/\xx}) {\bfseries\sffamily\small \x};
           }
