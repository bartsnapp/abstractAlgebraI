...
\def\sgn{\mathop{\rm sgn}} %% for quartic formula
...
\def\prodstar{\operatornamewithlimits{%
  \mathchoice{\vcenter{\hbox{\huge $\star$}}}
             {\vcenter{\hbox{\Large $\star$}}}
             {\star}
             {\star}}}
...
\newcommand\skipchapterstyle{%
  ...
  \def\maketitle{%
    \addtocounter{titlenumber}{1}%
                    ...
                    {\vskip .6em\noindent\textit\theabstract\setcounter{problem}{0}\setcounter{sectiontitlenumber}{0}}%
                    \par\vspace{2em}
                    \phantomsection\addcontentsline{toc}{section}{\textbf{\thetitlenumber\hspace{1em}\@title$^\star$}}%
                  }}

\newcommand\skipsectionstyle{%
  \def\activitystyle{activity-section}
  \def\maketitle{%
    \addtocounter{sectiontitlenumber}{1}
    {\flushleft\small\sffamily\bfseries\@pretitle\par\vspace{-1.5em}}%
    {\flushleft\Large\sffamily\bfseries\thetitlenumber.\thesectiontitlenumber\hspace{1em}\@title$^\star$ \par}%
    {\vskip .6em\noindent\textit\theabstract}%
    \par\vspace{2em}
    \phantomsection\addcontentsline{toc}{subsection}{\thetitlenumber.\thesectiontitlenumber\hspace{1em}\@title$^\star$}%
  }}
\makeatother
...
%%%% TIKZ STUFF
%% uses \usetikzlibrary{math} (above)
