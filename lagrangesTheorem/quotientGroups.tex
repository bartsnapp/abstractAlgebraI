...
\begin{example}[$\boldsymbol{\<f\>\not\normal D_3}$]\label{EG:fnn}\index{symmetries!of the equilateral triangle}
  If we arrange a Cayley table for $D_3$ appropriately, we can ``see''
...
\begin{itemize}
\item \link[\textit{Groups of rotationally symmetric permutations and magic mazes}, E.\ Behrends, Mathematische Semesterberichte, Volume 66, 2019, 157--164]{https://link-springer-com.proxy.lib.ohio-state.edu/article/10.1007\%2Fs00591-019-00258-z}.
%%Kaylee A. Submitted
\item \link[\textit{How rare are subgroups of index $2$?} J.\ Nganou, Mathematics Magazine, June (2012), Volume 85, 215--220]{https://www.jstor.org/stable/10.4169/math.mag.85.3.215}.
%%Amy M. Submitted
\item \link[\textit{Touching the $\Z_2$ in three-dimensional rotations}, V.\ Stojanoska and O.\ Stoytchev, Mathematics Magazine, December (2008), Volume 81, 345--357]{https://www.maa.org/sites/default/files/pdf/upload_library/22/Allendoerfer/Allendoerfer2009Stojanoska.pdf}.
