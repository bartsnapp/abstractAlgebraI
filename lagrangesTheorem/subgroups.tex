...
\begin{example}[Witnessing the subgroups of $\boldsymbol{D_3}$]
  ...
  \]
  If we associate all the non-black colors as the color white, then
  our picture has a symmetry group equal to $D_3$.
  ...
  If we associate yellow and any two other non-yellow colors as the
  color white, then our picture will have a symmetry group equal to
  $\< f\> \subgp D_3$,  $\< rf\> \subgp D_3$,  or $\< r^2f\> \subgp D_3$.
\end{example}
