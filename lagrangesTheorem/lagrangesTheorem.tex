...
\begin{example}[Counterexample to converse of Lagrange]
...
\begin{theorem}[A resolution to the question]
  ...
  \]
  The number of distinct polynomials found by permutating the
  variables of $F$ will divide $n!$.
    \begin{proof}
      From Lemma~\ref{L:cap}, we see that $[S_n:H]$ is the number of
      distinct polynomials found by permutating the variables. By
