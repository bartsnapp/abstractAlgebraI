...
\begin{theorem}[Counterexample to converse of Lagrange]\index{tetrahedral group}\index{alternating group}\index{symmetries!of the regular tetrahedron}
  ...
  \begin{proof}
    ...
    $a^2\in H$. But this cannot be, as each three-cycle in $A_4$ is
    the square of some element and there are eight distinct $3$-cycles
    in $A_4$
    \[
    (1\ 2\ 3), (1\ 3\ 2), (1\ 2\ 4), (1\ 4\ 2),
    (1\ 3\ 4), (1\ 4\ 3), (2\ 3\ 4), (2\ 4\ 3),
    \]
    which is greater than the order of $H$, a contradiction.
  \end{proof}
\end{theorem}
