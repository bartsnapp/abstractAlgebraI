...
\begin{exercise}
  Let $G$ be a cyclic group of order $n$, then if $d|n$, $G$ has a subgroup
  of order $d$.
\end{exercise}
...
\begin{itemize}
\item \link[\textit{Variations on a theme: $A_4$ definitely has no subgroup of order six!} 
  M.\ Brennan and D.\ Machale, Mathematics Magazine, February (2000), Volume 73, 36--40]{https://www.jstor.org/stable/2691487}.
\item \link[\textit{On the converse of Lagrange's theorem},
  J.\ Gallian, Mathematics Magazine, February (1993), Volume 66, 23]{https://www.maa.org/sites/default/files/On_the_Converse-Gallian34078.pdf}.
...
\item \link[\textit{A history of Lagrange's theorem on groups},
  R.\ Roth, Mathematics Magazine, April (2001), Volume 74, 99--198]{https://www.jstor.org/stable/2690624}.
\end{itemize}
