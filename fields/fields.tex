...
\begin{exercise}\label{E:FcmplxDis}
...
\begin{exercise}\label{E:cc}\index{complex numbers}
...
\begin{definition}
  A field $K$ is a \dfn{subfield} of a field $L$ if
  \begin{enumerate}
  \item $K\subset L$,
...
\begin{theorem}[Base fields of positive characteristic]\label{T:bfpc}
  ...
  \begin{sketch}
    ...
    is called the \dfn{base field} of $K$.
  \end{sketch}
\end{theorem}
...
\begin{theorem}[Base fields of characteristic zero]
  ...
  \begin{sketch}
    ...
    \begin{align*}
      ...
      b/a &\mapsto a^{-1} b.
    \end{align*}
    We must show that $\phi$ is \index{well-defined}well-defined.
    Suppose that
    \[
    \frac{b}{a} = \frac{d}{c},
    \]
