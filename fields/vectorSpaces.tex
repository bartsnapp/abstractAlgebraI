...
\begin{example}[Euclidean two-space]
...
\begin{example}[Euclidean three-space]
...
\begin{exercise}
  ...
  \begin{selectAll}
    \choice{$\{(x,y,z)\in\R^3:x^2 + y^2 + z^2 \le 4\}$ is a vector space.}
    \choice[correct]{$\{(x,y,z)\in\R^3: x + 2y + 3z = 0\}$ is a vector space.}
    \choice{$\{(x,y,z)\in\R^3:x^2 + y^2 +z^2 =0 \}$ is a vector space.}
    \choice{$\{(x,y,z)\in\R^3:x + 2y + 3z =4 \}$ is a vector space.}
    \choice[correct]{$\left\{(x,y,z)\in\R^3: A \left(\begin{smallmatrix} x\\ y\\ z\end{smallmatrix}\right) = 0\text{ where $A$ is a $3\times 3$ matrix}\right\}$ is a vector space.}
  \end{selectAll}
\end{exercise}
...
\begin{corollary}[Structure theorem for vector spaces]\label{C:stvs}
...
\begin{corollary}[Fields have prime-power order]
