...
\begin{exercise}
  ...
  your conclusion.
  \begin{enumerate}
  \item $x^2 + x +1$ over $\Z_2$.
  \item $x^3 + x + 1$ over $\Z_3$.
  \item $x^4+1$ over $\Z_5$.
  \item $x^2 + x + 4$ over $\Z_{11}$.
  \item $x^5 + 9x^4 + 12x^2 + 6$ over $\Q$.
  \item $17 x^3 - 7x^2 + 34x + 1$ over $\Q$.
  \item $x^4 + 10x + 1$ over $\Q$.
  \item $x^4 + 10x^2 + 1$ over $\Q$.
  \item $4x^3 -3x -1/2$ over $\Q$. 
\end{enumerate}
\end{exercise}
