...
amounts to solving what is known as the \index{discrete log problem}\link[discrete log problem]{https://en.wikipedia.org/wiki/Discrete_logarithm}. This is called the ``discrete log problem'' because we are talking about discrete sets, and 
$\log_b(b^x) = x$.
